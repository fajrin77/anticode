  ...
  return (
    <section className="mb-8" aria-label="Computer use capabilities">
      ...
      <div className="glass-surface overflow-hidden rounded-xl border border-line">
        <SettingRow title="antichat" hint="File, terminal, browser, internet, screenshot and MCP tools run in a private folder owned by each session; no project selection is required.">All tools · private folder</SettingRow>
